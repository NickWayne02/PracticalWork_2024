                    ...
                    <div class="banner-contents-slider">
                        <div class="header-inner-02 header-inner-04 header-inner-06">
                            ...
                            <div class="progress-wrapper">
                                ...
                                <span class="targets"> <?php echo e(__('Amount Raised:')); ?> <?php echo e(amount_with_currency_symbol($donation_cause->raised)); ?> </span>
                            </div>
                            ...
                            <div class="single-category">
                                ...
                                <div class="category-content color-five">
                                    <h4 class="category-para"> 
                                        <a href="<?php echo e(route('frontend.donations.category',['id' => $data->id,'any' => Str::slug($data->title) ?? '' ])); ?>"> <?php echo e($data->title ?? ''); ?> </a> 
                                    </h4>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\OSPanel\domains\localhost\@core\resources\views/frontend/home-pages/home-06.blade.php ENDPATH**/ ?>