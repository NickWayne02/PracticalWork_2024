                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.donations.settings')); ?>" method="POST"
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image','data' => ['name' => 'donation_single_reward_image','id' => 'donation_single_reward_image','value' => 'donation_single_reward_image']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\localhost\@core\resources\views/backend/donations/settings.blade.php ENDPATH**/ ?>