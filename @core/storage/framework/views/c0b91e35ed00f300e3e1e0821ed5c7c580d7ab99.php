                        ...
                        <form action="<?php echo e(route('admin.languages.new')); ?>" method="post" enctype="multipart/form-data" class="new_language_form">
                            ...
                            <div class="form-group">
                                ...
                                <select name="language_select" class="form-control">
                                    ...
                                    <option value="am" lang="am">Amharic</option>
                                    <option value="om" lang="om">Oromo</option>
                                    <option value="ti" lang="ti">Tigrinya</option>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\localhost\@core\resources\views/backend/languages/index.blade.php ENDPATH**/ ?>