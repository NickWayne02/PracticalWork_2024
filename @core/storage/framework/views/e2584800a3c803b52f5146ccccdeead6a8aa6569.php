        ...
        <div class="card">
            ...
            <div id="toyyibpay_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="payment-notice alert alert-warning">
                            <p><?php echo e(__('if your currency is not available in Toyyibpay, it will convert you currency value to MYR value based on your currency exchange rate.')); ?></p>
                        </div>
                        <label for="paytm_gateway"><strong><?php echo e(__('Enable/Disable Toyyibpay')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="toyyibpay_gateway"
                                   <?php if(!empty(get_static_option('toyyibpay_gateway'))): ?> checked
                                   <?php endif; ?> id="toyyibpay_gateway">
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="paytm_test_mode"><strong><?php echo e(__('Enable Test Mode For Toyyibpay')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="toyyibpay_test_mode"
                                   <?php if(!empty(get_static_option('toyyibpay_test_mode'))): ?> checked
                                    <?php endif; ?> >
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="site_logo"><strong><?php echo e(__('Toyyibpay Logo')); ?></strong></label>
                        <div class="media-upload-btn-wrapper">
                            <div class="img-wrap">
                                <?php
                            ...
                            <input type="hidden" id="toyyibpay_preview_logo"
                                   ...
                                   value="<?php echo e(get_static_option('toyyibpay_preview_logo')); ?>">
                            <button type="button"
                                    class="btn btn-info media_upload_form_btn"
                                    data-btntitle="<?php echo e(__('Select Image')); ?>"
                                    data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                    ...
                    <div class="form-group">
                        <label for="toyyibpay_secret_key"><?php echo e(__('Toyyibpay Secret kay')); ?></label>
                        <input type="text" name="toyyibpay_secret_key"  value="<?php echo e(get_static_option('toyyibpay_secret_key')); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="toyyibpay_category_code"><?php echo e(__('Toyyibpay Category Code')); ?></label>
        ...
        <div class="card">
            ...
            <div id="pagali_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="payment-notice alert alert-warning">
                            <p><?php echo e(__('if your currency is not available in Pagali, it will convert you currency value to USD value based on your currency exchange rate.')); ?></p>
                        </div>
                        <label for="paytm_gateway"><strong><?php echo e(__('Enable/Disable Pagali')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="pagali_gateway"
                                   <?php if(!empty(get_static_option('pagali_gateway'))): ?> checked
                                   <?php endif; ?> >
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="paytm_test_mode"><strong><?php echo e(__('Enable Test Mode For Pagali')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="pagali_test_mode"
                                   <?php if(!empty(get_static_option('pagali_test_mode'))): ?> checked
                                    <?php endif; ?> >
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="site_logo"><strong><?php echo e(__('Pagali Logo')); ?></strong></label>
                        <div class="media-upload-btn-wrapper">
                            <div class="img-wrap">
                                <?php
                            ...
                            <input type="hidden" id="pagali_preview_logo"
                                   ...
                                   value="<?php echo e(get_static_option('pagali_preview_logo')); ?>">
                            <button type="button"
                                    class="btn btn-info media_upload_form_btn"
                                    data-btntitle="<?php echo e(__('Select Image')); ?>"
                                    data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                    ...
                    <div class="form-group">
                        <label for="pagali_page_id"><?php echo e(__('Pagali Page ID')); ?></label>
                        <input type="text" name="pagali_page_id" value="<?php echo e(get_static_option('pagali_page_id')); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="pagali_entity_id"><?php echo e(__('Pagali Entity ID')); ?></label>
        ...
        <div class="card">
            ...
            <div id="authorizenet_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="payment-notice alert alert-warning">
                            <p><?php echo e(__('if your currency is not available in Authorize.net, it will convert you currency value to USD value based on your currency exchange rate.')); ?></p>
                        </div>
                        <label for="paytm_gateway"><strong><?php echo e(__('Enable/Disable Authorize.net')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="authorizenet_gateway"
                                   <?php if(!empty(get_static_option('authorizenet_gateway'))): ?> checked
                                   <?php endif; ?> id="authorizenet_gateway">
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="authorizenet_test_mode"><strong><?php echo e(__('Enable Test Mode For Authorize.net')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="authorizenet_test_mode"
                                   <?php if(!empty(get_static_option('authorizenet_test_mode'))): ?> checked
                                    <?php endif; ?> >
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="site_logo"><strong><?php echo e(__('Authorize.net Logo')); ?></strong></label>
                        <div class="media-upload-btn-wrapper">
                            <div class="img-wrap">
                                <?php
                            ...
                            <input type="hidden" id="authorizenet_preview_logo"
                                   ...
                                   value="<?php echo e(get_static_option('authorizenet_preview_logo')); ?>">
                            <button type="button"
                                    class="btn btn-info media_upload_form_btn"
                                    data-btntitle="<?php echo e(__('Select Image')); ?>"
                                    data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                    ...
                    <div class="form-group">
                        <label for="authorizenet_merchant_login_id"><?php echo e(__('Authorize.net Merchant Login ID')); ?></label>
                        <input type="text" name="authorizenet_merchant_login_id" value="<?php echo e(get_static_option('authorizenet_merchant_login_id')); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="authorizenet_merchant_transaction_id"><?php echo e(__('Authorize.net Merchant Transaction ID')); ?></label>
                        <input type="text" name="authorizenet_merchant_transaction_id" value="<?php echo e(get_static_option('authorizenet_merchant_transaction_id')); ?>" class="form-control">
                    </div>
        ...
        <div class="card">
            ...
            <div id="SitesWay_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="payment-notice alert alert-warning">
                            <p><?php echo e(__('if your currency is not available in SitesWay, it will convert you currency value to USD value based on your currency exchange rate.')); ?></p>
                        </div>
                        <label for="sitesway_gateway"><strong><?php echo e(__('Enable/Disable SitesWay')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="zisitesway_gateway"
                                   <?php if(!empty(get_static_option('zisitesway_gateway'))): ?> checked
                                   <?php endif; ?> >
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="sitesway_test_mode"><strong><?php echo e(__('Enable Test Mode For SitesWay')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="sitesway_test_mode"
                                   <?php if(!empty(get_static_option('sitesway_test_mode'))): ?> checked
                                    <?php endif; ?> >
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="site_logo"><strong><?php echo e(__('SitesWay Logo')); ?></strong></label>
                        <div class="media-upload-btn-wrapper">
                            <div class="img-wrap">
                                <?php
                            ...
                            <input type="hidden"
                                   ...
                                   value="<?php echo e(get_static_option('sitesWay_preview_logo')); ?>">
                            <button type="button"
                                    class="btn btn-info media_upload_form_btn"
                                    data-btntitle="<?php echo e(__('Select Image')); ?>"
                                    data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                    ...
                    <div class="form-group">
                        <label for="sitesway_brand_id"><?php echo e(__('SitesWay Brand ID')); ?></label>
                        <input type="text" name="sitesway_brand_id" value="<?php echo e(get_static_option('sitesway_brand_id')); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="sitesway_api_key"><?php echo e(__('SitesWay Api Key')); ?></label>
...
</div><?php /**PATH C:\OSPanel\domains\localhost\@core\resources\views/backend/general-settings/gateway-portion/credentials.blade.php ENDPATH**/ ?>