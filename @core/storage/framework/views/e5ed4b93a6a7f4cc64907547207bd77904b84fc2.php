<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Donations Form Builder')); ?>
...
<?php endif; ?>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__("Donations Form Builder")); ?></h4>
                        <div class="alert alert-danger alert-block ">
                            <strong><i class="ti-hand-point-right mr-1"></i> <?php echo e(__("Note: Please, don't add Name & Email Form Fields here!")); ?></strong>
                        </div>
                        <form action="<?php echo e(route('admin.form.builder.donation.form')); ?>" method="Post"><?php echo csrf_field(); ?>
                            <?php echo render_drag_drop_form_builder_markup(get_static_option('donation_page_form_fields')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\localhost\@core\resources\views/backend/form-builder/donation-form.blade.php ENDPATH**/ ?>